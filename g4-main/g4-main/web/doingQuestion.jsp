            ...
            <div class="quiz_wrap_wrap">
                ...
                <c:forEach items="${lqac}" var="q">
                    ...
                    <c:forEach items="${q.answer}" var="a">
                        <button onclick="window.location = 'doingQuestion?mode=answer&answer=${a.content}&questionID=${q.question.id}&lessonID=${lessonID}&courseID=${courseID}'" class="quiz_answer
