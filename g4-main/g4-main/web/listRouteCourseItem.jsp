                       ...
                       <c:forEach items="${listRouteTypeItem}" var="i">
                            <tr>
                                ...
                                <td style="display: flex
                                    ...
                                    <div name="btn_delete" onclick="deleteRouteCourseItem(${i.id})" value="${itemCourse.getCourseID()}"    class="btn_delete" style="text-align: center;justify-content: center;margin-left: 10px; width: 50px; cursor: pointer;height: 25px;border:1px #807171 solid;border-radius: 2px;background-color: #F0F0F0 ;font-size: 14px">Xóa</div>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
